...
LOCAL_SRC_FILES := $(TOOLCHAIN_DIR)/user/$(TARGET_ARCH_ABI)/lib/lib$(LOCAL_MODULE)$(LIB_TYPE_SUFFIX).so
LOCAL_EXPORT_C_INCLUDES := $(TOOLCHAIN_DIR)/user/$(TARGET_ARCH_ABI)/include
